...
def main():
    ...
    vessel_position = vessel.position(vessel.orbit.body.non_rotating_reference_frame)
    vessel_position = vessel.velocity(vessel.orbit.body.non_rotating_reference_frame)
    vessel_position = (vessel_position[0], vessel_position[2], vessel_position[1])
    vessel_velocity = (vessel_position[0], vessel_position[2], vessel_position[1])
